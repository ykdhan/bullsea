...
class NotificationController extends GetxController {
  ...
  void _getToken() async {
    ...
    try {
      // deviceUID 등록
      BSRequest.post('notification', {'deviceUid': token}, (result) {
  ...
  void _onMessage() async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      if (notification != null) {
        ...
        print('Message with notification: ${message.notification!.body}');
      }

      // BSRequest.get('oracle/here?location=on_message', (result) async {});
    });

    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) async {
      print('open app message: $message');
      // BSRequest.get('oracle/here?location=opened_app', (result) async {});
  ...
  Future<void> _onMessageBackground(RemoteMessage message) async {
    ...
    // BSRequest.get('oracle/here?location=background', (result) async {});
  }
}
